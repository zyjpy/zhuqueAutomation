...
class CreatCourse(unittest.TestCase):
    ...
    def test_002_checkWorkNopass(self):
        '''审核第1，2作品不通过'''
        self.driver.get("https://staging.www.qiaojianyun.com/basicadmin/#/shequ/examine/index")
        time.sleep(3)
        #点击审核不通过的第三个作品 猴子2
        self.driver.find_element(By.XPATH, sheet4.cell_value(17,4)).click()
        time.sleep(1)
    ...
    def test_005_republishWork(self):
        ...
        self.driver.find_elements_by_class_name('word')[1].click()
        time.sleep(3)
        #截图作品详情页
        pic = ImageGrab.grab((0,0,1800,1040))
        pic.save('./screenshot/002_作品详情.jpg')

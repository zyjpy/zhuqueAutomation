...
class CreatCourse(unittest.TestCase):
    ...
    def test_001_creatWorkSaveDraft(self):
        ...
        time.sleep(3)
        #选择第一个模型预览
        self.driver.find_elements_by_class_name("el-button--small")[5].click()
        time.sleep(3)
        pic = ImageGrab.grab((0,0,1800,1040))
        pic.save('./screenshot/001_选择模型窗口预览模型.jpg')
        self.driver.find_elements_by_class_name("el-icon-close")[4].click()
        time.sleep(1)
